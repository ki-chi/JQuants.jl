...
function datascheme(::FinsStatements)
    DataScheme([
        ...
        ColType(:NextFiscalYearStartDate, String, Union{Date,Missing}),
        ColType(:NextFiscalYearEndDate, String, Union{Date,Missing}),
        ...
        ColType(Symbol("DistributionsPerUnit(REIT)"), String, Union{Float64,Missing}),
        ...
        ColType(:ForecastTotalDividendPaidAnnual, String, Union{Float64,Missing}),
        ColType(:ForecastPayoutRatioAnnual, String, Union{Float64,Missing}),
        ColType(Symbol("ForecastDistributionsPerUnit(REIT)"), String, Union{Float64,Missing}),
        ...
        ColType(Symbol("NextYearForecastDistributionsPerUnit(REIT)"), String, Union{Float64,Missing}),
        ...
        ColType(:NextYearForecastNetSales, String, Union{Float64, Missing}),
        ColType(:NextYearForecastOperatingProfit, String, Union{Float64, Missing}),
        ColType(:NextYearForecastOrdinaryProfit, String, Union{Float64, Missing}),
        ColType(:NextYearForecastProfit, String, Union{Float64, Missing}),
        ColType(:NextYearForecastEarningsPerShare, String, Union{Float64, Missing}),
